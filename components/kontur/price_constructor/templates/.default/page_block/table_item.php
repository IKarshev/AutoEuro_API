<tr class="rule_item">
    <td class="ID width50"><?=$arResult["LastItem"]?></td>
    <td>
        <select class="js-select2 filter_global_type" name="" id="">
            <option value="" disabled selected>Выберите тип фильтрации</option>

            <?foreach ($arResult["filter_type"] as $arkey => $arItem):?>
                <option value="<?=$arkey?>"><?=$arItem?></option>
            <?endforeach;?>
            
        </select>
    </td>
    <td class="width360">
        <select class="js-select2 filter_items" name="" id="">
            <option value="" disabled selected>Выберите поле фильтрации</option>
        </select>
    </td>
    <td>
        <select class="js-select2 filter_type" name="" id="">
            <option value="" disabled selected>Выберите значение фильтрации</option>
            <option value="="> = </option>
            <option value=">"> > </option>
            <option value=">="> >= </option>
            <option value="<"> < </option>
    ...
    <td>
        <input class="firts_field" type="text" placeholder="Введите">
    </td>
    <td>
        <select class="js-select2 markup_type" name="" id="">
            <option value="" disabled selected>Выберитие</option>
            <option value="%">%</option>
            <option value="+">+</option>
        </select>
    </td>
    <td>
        <input class="markup_value" type="text" placeholder="Введите значение наценки">
    </td>
    <td>
        <a href="" data-item_id="<?=$arResult["LastItem"]?>" class="delete_item new">
